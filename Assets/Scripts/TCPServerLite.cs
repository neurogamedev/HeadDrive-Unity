...
public class TCPServerLite : MonoBehaviour
{
    // the controller script attached to the car
    HeadTilt HeadTiltController;
    ...
    void Start()
    {
        // Attach a Tag "Player" on the car
        HeadTiltController = GameObject.FindWithTag("Player").GetComponent<HeadTilt>();
            ...
            while(true) {
                ...
                int length;
                 ...
                 while ((length = stream.Read(bytes, 0, bytes.Length)) != 0) {
                    ...
                    HeadTiltController.parseMessage(clientMessage);
